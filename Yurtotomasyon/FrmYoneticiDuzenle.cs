...
namespace Yurtotomasyon
{
    public partial class FrmYoneticiDuzenle : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            bgl.baglanti().Close();
            MessageBox.Show("Yönetici Başarıyla Eklenmiştir");
            this.adminTableAdapter.Fill(this.yurtotomasyonDataSet5.Admin);
        }
        ...
        private void BtnSil_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Silme İşlemi Başarıyla Gerçekleştirilmiştir");
            this.adminTableAdapter.Fill(this.yurtotomasyonDataSet5.Admin);
        }
        ...
        private void BtnGuncelle_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery();
            bgl.baglanti().Close();
            MessageBox.Show("Güncelleme Başarıyla Gerçekleştirilmiştir");
            this.adminTableAdapter.Fill(this.yurtotomasyonDataSet5.Admin);
        }
    }
}
