...
namespace Yurtotomasyon
{
    public partial class FrmGider : Form
    {
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            try
            {
                SqlCommand komut = new SqlCommand("insert into Giderler(Elektrik, Su, Dogalgaz, internet, Gıda," +
                "Personel, Diger) Values (@p1, @p2, @p3, @p4, @p5, @p6, @p7)", bgl.baglanti());
            ...
            {
                MessageBox.Show("Hata oluştu. Kayıtlar eklenemedi");
            }
